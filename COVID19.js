...
{
 "use strict";
 var Global,FsRoot,Library,Monads,Seq,Async,String,ParseO,TestingJS,Covid,WebSharper,Operators,Utils,Arrays,Unchecked,Obj,Collections,Dictionary,CancellationTokenSource,UI,Var$1,Var,View,SC$1,Seq$1,List,T,Char,Slice,Strings,Map,FSharp,Data,Runtime,IO,FSharpMap,AttrModule,JavaScript,JS,HtmlModule,attr,Doc,EventTarget,Node,Pervasives,Object,DictionaryUtil,Error,AggregateException,Concurrency,ConcreteVar,Snap,Abbrev,Async$1,Numeric,System,Guid,Enumerator,T$1,Data$1,TxtRuntime,Pervasives$1,MapUtil,AttrProxy,Array,Docs,Client,Templates,WindowOrWorkerGlobalScope,CT,AsyncBody,Fresh,DateUtil,TimeoutException,BalancedTree,Pair,Tree,SC$2,Attrs,DomUtility,DocElemNode,Scheduler,OperationCanceledException,HashSet,CharacterData,Attrs$1,Dyn,SC$3,SC$4,An,Settings,Mailbox,SC$5,Elt,SC$6,Prepare,KeyCollection,Docs$1,RunState,NodeSet,Anims,SC$7,FormatException,Updates,DynamicAttrNode,Queue,SC$8,AppendList,Easing,HashSet$1,HashSetUtil,DomNodes,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,console,JSON,IntelliFactory,Runtime$1,Date,$,Math;
 Global=self;
 ...
 {
  return Map.TryFind(st,Covid.statesPop2019());
 };
 ...
 Covid.getStateDaily=function(st)
 {
 ...
 Covid.daily=function()
 {
  SC$1.$cctor();
  return SC$1.daily;
 };
 Covid.deathsWeekA=function(st)
 {
  var b;
  b=null;
  return Concurrency.Delay(function()
  {
   ...
   {
    var deaths;
    function getPrior(n,d)
    {
     var o;
     o=Map.TryFind(d+n*86400000,deaths);
     return o==null?0:o.$0;
    }
    deaths=new FSharpMap.New(Seq$1.sort(Arrays.choose(function(d)
    {
     ...
     return o==null?null:{
      ...
      $0:[(new Global.Date((v=(prop$1="date",prop$1 in d?{
       ...
       $:1,
       $0:1*v$2.$0
      },opt$2==null?null:opt$2.$0))%100)).getTime(),o.$0]
     };
    },a)));
    return Concurrency.Return(Seq$1.map(function(kvp)
    {
     return[kvp.K,kvp.V-getPrior(-7,kvp.K)];
    },deaths));
   });
  });
 };
 Covid.deathsWeek=function(st)
 {
  var b;
  b=null;
  return Concurrency.Delay(function()
  {
   return Concurrency.Bind(Covid.deathsWeekA(st),function(a)
   {
    return Concurrency.Return([st,a]);
   });
  });
 };
 Covid.printdeathsWeek=function(st)
 {
  var b;
  Concurrency.Start((b=null,Concurrency.Delay(function()
  {
 ...
 Covid.functionW=function()
 {
  SC$1.$cctor();
  return SC$1.functionW;
 };
 Covid.main=function()
 {
  var x,x$1,a;
  function a$1(date,deaths)
  {
   var totalDeaths,totalPopW,f,f$1;
   function p(y)
   {
    return"US"!==y;
   }
   function g(s)
   {
    return Seq$1.choose(Covid.getStatePop,s);
   }
   totalDeaths=Seq$1.sum(Seq$1.choose(function(kvp)
   {
    return kvp.K==="US"?null:{
     $:1,
     $0:kvp.V[0]
    };
   },deaths));
   totalPopW=View.Map((f=(f$1=function(s)
   {
   ...
   {
    return Seq$1.sum(f(x$2));
   }),Covid.statesW());
   return Doc.Element("tr",[],[Doc.Element("td",[],[Doc.TextNode((new Global.Date(date)).toLocaleDateString())]),Doc.Convert(function(st)
   {
    var o,o$1;
    return Doc.Element("td",[],[Doc.TextNode((o=(o$1=Map.TryFind(st,deaths),o$1==null?null:o$1.$0[1]),o==null?"":o.$0))]);
   },Covid.statesW()),Doc.Element("th",[],[Doc.TextView(View.Map2(function($1,$2)
   {
    return($1($2))(totalDeaths);
   },Covid.functionW(),totalPopW))])]);
  }
  x=Doc.Element("div",[AttrModule.Class("container")],[Doc.Element("h1",[],[Doc.TextNode("Covid Statistics")]),Doc.Element("button",[AttrProxy.HandlerImpl("click",function()
  {
   return function()
   {
    return Global.alert("Hello");
   };
  })],[Doc.TextNode("Press Me!")]),Doc.Element("div",[],[Doc.TextNode("State: "),Doc.Input([AttrProxy.Create("style","width: 300px")],Covid.statesV())]),Doc.Element("div",[],[Doc.TextNode("Data: "),Doc.Select([],Global.id,List.map(function(t)
  {
   return t[0];
  },Covid.funcs()),Covid.functionV())]),Doc.Element("table",[AttrModule.Class("table table-sm")],[Doc.Element("tr",[],[Doc.Element("th",[],[Doc.TextNode("Date")]),Doc.Convert(function(st)
  {
   return Doc.Element("th",[],[Doc.TextNode(st)]);
  },Covid.statesW()),Doc.Element("th",[],[Doc.TextNode("Total")])]),Doc.Convert(function($1)
  {
   return a$1($1[0],$1[1]);
  },(x$1=View.MapAsync(Concurrency.Parallel,View.Map(function(a$2)
  {
   return Arrays.map(Covid.deathsWeek,a$2);
  },Covid.statesW())),View.Map2(function(f,sts)
  {
   function f$1(all,t)
   {
    var st;
    function f$2(m,t$1)
    {
     var d,v,per100kO,o,x$2,v$1;
     d=t$1[0];
     v=t$1[1];
     per100kO=(o=Covid.getStatePop(st),o==null?null:{
      $:1,
      $0:(f(o.$0))(v)
     });
     return m.Add(d,(x$2=Map.TryFind(d,m),(v$1=new FSharpMap.New([]),x$2==null?v$1:x$2.$0)).Add(st,[v,per100kO]));
    }
    st=t[0];
    return(((Runtime$1.Curried3(Seq$1.fold))(f$2))(all))(t[1]);
   }
   return Seq$1.sortDescending(Seq$1.map(function(kvp)
   {
    return[kvp.K,kvp.V];
   },(((Runtime$1.Curried3(Seq$1.fold))(f$1))(new FSharpMap.New(T.Empty)))(sts)));
  },Covid.functionW(),x$1)))]),Doc.Verbatim("<link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css\" integrity=\"sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh\" crossorigin=\"anonymous\"> ")]);
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.daily=Covid.getStateDaily("TX");
  SC$1.ahora=Date.now();
  SC$1.statesV=Var$1.Create$1("TX NJ CT NY MA MI LA PA US");
  SC$1.delayedV=Library.delayedVar(1000,Covid.statesV());
  SC$1.statesW=View.Map(function(sts)
  {
   return Strings.SplitChars(Strings.Trim(sts),[" "],0);
  },Covid.delayedV().get_View());
  SC$1.funcs=List.ofArray([["daily deaths (smoothed)",function()
  {
   return function(v)
   {
    return Covid.thousands(v/7>>0);
   };
  }],["weekly deaths",function()
  {
   return Covid.thousands;
  }],["yearly deaths",function()
  {
   return function(v)
   {
    return Covid.thousands(v*52);
   };
  }],["deaths per 100K",function(pop)
  {
   return function(v)
   {
    return Covid.thousands(v*52*100000/pop>>0);
   };
  }],["population",function(pop)
  {
   return function()
   {
    return Covid.thousands(pop);
   };
  }]]);
  SC$1.functionV=Var$1.Create$1((Seq$1.head(Covid.funcs()))[0]);
  SC$1.functionW=View.Map(function(nm)
  {
   function f$3(t)
   {
    return t[0];
