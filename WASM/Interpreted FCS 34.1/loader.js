...
var App = {
	preloaded : "/tmp",
	init: function () {
		this.listdir         = Module.mono_bind_static_method ("[WasmTest3] FsRoot.WasmTest:listdir"    );
		this.printFile       = Module.mono_bind_static_method ("[WasmTest3] FsRoot.WasmTest:printFile"  );
		this.writeFile       = Module.mono_bind_static_method ("[WasmTest3] FsRoot.WasmTest:writeFile"  );
		this.runAsm          = Module.mono_bind_static_method ("[WasmTest3] FsRoot.WasmTest:runAssembly");
		this.fsiEval		 = Module.mono_bind_static_method ("[WasmTest3] FsRoot.WasmTest:fsiEval"    );
		this.compile         = Module.mono_bind_static_method ("[WasmTest3] FsRoot.WasmTest:compile"    );
		this.translate       = Module.mono_bind_static_method ("[WasmTest3] FsRoot.WasmTest:translate"  );
		this.wait            = Module.mono_bind_static_method ("[WasmTest3] FsRoot.WasmTest:wait"       );
		AppInitiated = true;
